...
The easiest method of installation is by downloading and executing a precompiled binary from the [Release Page](https://github.com/inkdevhub/swanky-node/releases)
...
[genesis state](https://github.com/inkdevhub/swanky-node/blob/main/node/src/chain_spec.rs#L44).
